...
class Index extends Component
{
    ...
    public function render()
    {
        ...
        $count_super_admins = User::where('user_level', USER_ROLES::SUPER_ADMIN->value)->count();
        $count_admins = User::where('user_level', USER_ROLES::ADMIN->value)->count();
        $count_users = User::where('user_level', USER_ROLES::USER->value)->count();
        // $count_owners = User::where('user_level', USER_ROLES::OWNER->value)->count();
